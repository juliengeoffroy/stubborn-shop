 ...
 */
final class Version20250516161936 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE name name VARCHAR(255) DEFAULT 'NULL', CHANGE delivery_address delivery_address VARCHAR(255) DEFAULT 'NULL', CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`
        SQL);
    }
}
